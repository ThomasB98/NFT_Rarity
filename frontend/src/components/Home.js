/**
 * It maps over the collections array and returns a card for each collection
 * @returns A card component that displays the name, contract address, and chain of the collection.
 */
