/**
 * It takes the contract address from the URL, finds the collection in the collections.js file, and
 * then uses the contract address to get the collection data from the backend. It then displays the
 * collection data in a nice way
